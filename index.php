						...
						data-description="Science says that Women are generally happier">
							...
							<div class="mainText tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									BARANGAY <span style="color: #A2A2A2;">SALVACION 1ST</span>
							</div>
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
									 MUNICIPALITY OF LUPAO, NUEVA ECIJA
							</div>
							<!-- LAYER NR. 4 -->
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; white-space: nowrap;text-transform:uppercase; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
									<span style="font-size: 23px;">MAUNLAD NA LUPAO, NUEVA ECIJA</span> 
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							...
							<p>Officials of Barangay Salvacion 1st.</p>
						</div>
					</div>	
					 <div class="row">
                ...
                <div class="container">
					<div class="row">
						<div class="heading-bx left">
							...
							<p>Barangay Salvacion 1st can generate brgy. clearance, certificate of indigency.</p>
						</div>
					</div>	
					...
					<div class="row">
						<div class="col-lg-6 col-md-12">
							<div class="heading-bx left">
								...
								<a href="<?php echo $fb_link; ?>" style="font-size: 20px;color: black;"><i class="fa fa-facebook" style="font-size: 25px;color: #333333;"></i> &nbsp;Barangay Salvacion 1st</a><br>
								<div style="height: 5px;"></div>

								<a href="<?php echo $fb_link; ?>" style="font-size: 20px;color: black;"><i class="fa fa-envelope" style="font-size: 20px;color: #333333;"></i> barangay.salvacion.1st@gmail.com</a><br>
								<div style="height: 5px;"></div>
								<?php
						...
						<div class="col-lg-6 col-md-12">
							<div class="container2">
								<iframe src="https://maps.google.com/maps?q=Brgy.%20Salvacion%201st,%20Lupao&t=&z=13&ie=UTF8&iwloc=&output=embed" class="responsive-iframe" loading="lazy"></iframe>
							</div>
						</div>
					</div>
					<br><br><br><br><br><br>
